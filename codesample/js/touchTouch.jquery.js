...
(function(){
	...
	var overlay = $('<div id="xe-galleryOverlay">'),
		slider = $('<div id="xe-gallerySlider">'),
		prevArrow = $('<a id="xe-prevArrow"><i class="xi-angle-left-thin"></i></a>'),
		nextArrow = $('<a id="xe-nextArrow"><i class="xi-angle-right-thin"></i></a>'),
		overlayClose =$('<button id="btn-overlay-close"><i class="xi-close"></i></button>'),		
